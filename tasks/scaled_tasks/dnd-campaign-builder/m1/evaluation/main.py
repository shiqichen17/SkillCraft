#!/usr/bin/env python3
"""Evaluation for dnd-campaign-builder-m1: 4 characters × 4 APIs"""
...
EXPECTED_NAMES = ['human fighter', 'elf wizard', 'dwarf cleric', 'halfling rogue']
EXPECTED_COUNT = 4
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("dnd-campaign-builder-m1")
