#!/usr/bin/env python3
"""Evaluation for dnd-campaign-builder-e1: 3 characters × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['build_name', 'combat_rating', 'versatility_score', 'class', 'race', 'equipment']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("dnd-campaign-builder-e1")
