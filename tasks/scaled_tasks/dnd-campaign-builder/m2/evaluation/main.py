#!/usr/bin/env python3
"""Evaluation for dnd-campaign-builder-m2: 4 characters × 4 APIs"""
...
EXPECTED_COUNT = 4
REQUIRED_FIELDS = ['build_name', 'combat_rating', 'versatility_score', 'class', 'race', 'spells']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("dnd-campaign-builder-m2")
