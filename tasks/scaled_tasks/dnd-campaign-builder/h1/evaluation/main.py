#!/usr/bin/env python3
"""Evaluation for dnd-campaign-builder-h1: 5 characters × 5 APIs"""
...
EXPECTED_NAMES = ['human fighter', 'elf wizard', 'dwarf cleric', 'halfling rogue', 'dragonborn paladin']
EXPECTED_COUNT = 5
REQUIRED_FIELDS = ['build_name', 'combat_rating', 'versatility_score', 'class', 'race', 'spells', 'equipment']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("dnd-campaign-builder-h1")
