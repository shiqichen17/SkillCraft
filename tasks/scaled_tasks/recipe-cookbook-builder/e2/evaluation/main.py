#!/usr/bin/env python3
"""Evaluation for recipe-cookbook-builder-e2: 3 dishes × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['name', 'difficulty_rating', 'estimated_cooking_time_min', 'category', 'cuisine', 'category_dishes']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("recipe-cookbook-builder-e2")
