#!/usr/bin/env python3
"""Evaluation for openmeteo-weather-e2: 3 cities × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['name', 'coordinates', 'hourly_forecast', 'daily_forecast']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("openmeteo-weather-e2")
