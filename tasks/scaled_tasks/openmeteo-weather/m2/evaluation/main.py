#!/usr/bin/env python3
"""Evaluation for openmeteo-weather-m2: 4 cities × 4 APIs"""
...
EXPECTED_COUNT = 4
REQUIRED_FIELDS = ['name', 'coordinates', 'hourly_forecast', 'daily_forecast', 'historical']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("openmeteo-weather-m2")
