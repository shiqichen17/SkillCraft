# Task: Weather Monitor (4 Cities × 4 APIs) - M2
...
2. **Hourly**: 168-hour forecast
3. **Daily**: 14-day forecast
4. **Historical**: 30-day history
...
2. `local-weather_get_hourly`
3. `local-weather_get_daily`
4. `local-weather_get_historical`
