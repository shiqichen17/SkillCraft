#!/usr/bin/env python3
"""Evaluation for cocktail-menu-generator-h1: 5 cocktails × 5 APIs"""
...
EXPECTED_NAMES = ['margarita', 'mojito', 'old fashioned', 'martini', 'cosmopolitan']
EXPECTED_COUNT = 5
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("cocktail-menu-generator-h1")
