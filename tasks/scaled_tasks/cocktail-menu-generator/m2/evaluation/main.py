#!/usr/bin/env python3
"""Evaluation for cocktail-menu-generator-m2: 4 cocktails × 4 APIs"""
...
EXPECTED_NAMES = ['margarita', 'mojito', 'old fashioned', 'martini']
EXPECTED_COUNT = 4
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("cocktail-menu-generator-m2")
