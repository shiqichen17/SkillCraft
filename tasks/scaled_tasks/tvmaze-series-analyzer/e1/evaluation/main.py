#!/usr/bin/env python3
"""
Evaluation script for tvmaze-series-analyzer-e1 task.
...
REQUIRED_FIELDS = ['id', 'name', 'marathon_hours', 'binge_rating', 'rating', 'seasons', 'episodes']
...
def evaluate(workspace: str, groundtruth_dir: str) -> Dict[str, Any]:
    score = EvalScore("tvmaze-series-analyzer-e1")
