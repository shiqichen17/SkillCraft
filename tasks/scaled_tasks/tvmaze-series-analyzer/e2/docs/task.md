# Task: TV Series Analysis (3 Shows × 3 APIs) - E2
  ...
  "shows": [
    {
      "id": 169,
      "name": "Breaking Bad",
      "rating": 9.5, "status": "Ended", "genres": ["Drama"], "network": "AMC", "episodes": {"total_count": 62, "avg_rating": 9.2, "highest_rated": {"name": "Ozymandias", "rating": 10.0}}, "cast": {"total_count": 50, "leads": [{"actor": "Bryan Cranston", "character": "Walter White"}]},
      "marathon_hours": 46.5,
      "binge_rating": "A+"
    }
  ],
