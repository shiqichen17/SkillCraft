#!/usr/bin/env python3
"""Evaluation for name-demographics-analyzer-m2: 4 names × 4 APIs"""
...
EXPECTED_COUNT = 4
REQUIRED_FIELDS = ['name', 'profile', 'gender', 'nationality']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("name-demographics-analyzer-m2")
