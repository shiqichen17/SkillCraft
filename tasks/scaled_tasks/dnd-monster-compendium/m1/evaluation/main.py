#!/usr/bin/env python3
"""Evaluation for dnd-monster-compendium-m1: 4 monsters × 4 APIs"""
...
EXPECTED_INDICES = ['adult-red-dragon', 'kraken', 'aboleth', 'lich']
EXPECTED_COUNT = 4
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("dnd-monster-compendium-m1")
