# Task: Dog Breeds Encyclopedia (3 Breeds × 3 APIs) - E3
...
2. **All Sub-breeds**: complete sub-breed list
3. **Gallery**: comprehensive image gallery
...
2. `local-dog_breed_all_sub_breeds`
3. `local-dog_breed_gallery`
