#!/usr/bin/env python3
"""Evaluation for dog-breeds-encyclopedia-h1: 5 breeds × 5 APIs"""
...
EXPECTED_BREEDS = ['retriever', 'spaniel', 'bulldog', 'hound', 'terrier']
EXPECTED_COUNT = 5
REQUIRED_FIELDS = ['breed', 'display_name', 'diversity_index', 'popularity_tier', 'sub_breed_count', 'sample_images']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("dog-breeds-encyclopedia-h1")
