#!/usr/bin/env python3
"""Evaluation for dog-breeds-encyclopedia-e2: 3 breeds × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['breed', 'display_name', 'diversity_index', 'popularity_tier', 'sample_images']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("dog-breeds-encyclopedia-e2")
