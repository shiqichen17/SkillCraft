#!/usr/bin/env python3
"""Evaluation for university-directory-builder-e3: 3 countries × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['country', 'statistics', 'education_rank', 'tier']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("university-directory-builder-e3")
