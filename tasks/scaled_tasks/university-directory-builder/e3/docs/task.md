# Task: University Directory (3 Countries × 3 APIs) - E3
...
1. **By Name**: search by university name
2. **Search**: comprehensive search
...
1. `local-university_by_name`
2. `local-university_search`
