#!/usr/bin/env python3
"""Evaluation for jsonplaceholder-blog-analyzer-h1: 5 users × 5 APIs"""
...
EXPECTED_USERS = {1: {"name": "Leanne Graham", "posts": 10, "todos": 20},
    ...
    4: {"name": "Patricia Lebsack", "posts": 10, "todos": 20},
    5: {"name": "Chelsey Dietrich", "posts": 10, "todos": 20}}
EXPECTED_COUNT = 5
REQUIRED_FIELDS = ['user_id', 'metrics', 'profile', 'activity']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("jsonplaceholder-blog-analyzer-h1")
