# Task: Blog User Analysis (3 Users × 3 APIs) - E3
...
1. **Posts**: all posts with content
2. **Todos**: all todos with completion status
...
1. `local-jsonplaceholder_get_posts`
2. `local-jsonplaceholder_get_todos`
