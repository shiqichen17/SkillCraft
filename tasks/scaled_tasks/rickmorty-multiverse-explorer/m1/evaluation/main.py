#!/usr/bin/env python3
"""Evaluation for rickmorty-multiverse-explorer-m1: 4 characters × 4 APIs"""
...
EXPECTED_COUNT = 4
KNOWN_DATA = {1: {"name": "Rick Sanchez", "status": "Alive", "species": "Human", "min_episodes": 40}, 2: {"name": "Morty Smith", "status": "Alive", "species": "Human", "min_episodes": 40}, 3: {"name": "Summer Smith", "status": "Alive", "species": "Human", "min_episodes": 30}, 4: {"name": "Beth Smith", "status": "Alive", "species": "Human", "min_episodes": 30}}
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("rickmorty-multiverse-explorer-m1")
