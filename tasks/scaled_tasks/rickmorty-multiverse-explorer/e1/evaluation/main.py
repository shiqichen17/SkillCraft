#!/usr/bin/env python3
"""Evaluation for rickmorty-multiverse-explorer-e1: 3 characters × 3 APIs"""
...
REQUIRED_FIELDS = ['id', 'name', 'significance_score', 'significance_tier', 'status', 'species', 'origin']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("rickmorty-multiverse-explorer-e1")
