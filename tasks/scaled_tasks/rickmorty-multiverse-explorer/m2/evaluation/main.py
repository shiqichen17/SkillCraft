#!/usr/bin/env python3
"""Evaluation for rickmorty-multiverse-explorer-m2: 4 characters × 4 APIs"""
...
REQUIRED_FIELDS = ['id', 'name', 'significance_score', 'significance_tier', 'status', 'species', 'episodes']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("rickmorty-multiverse-explorer-m2")
