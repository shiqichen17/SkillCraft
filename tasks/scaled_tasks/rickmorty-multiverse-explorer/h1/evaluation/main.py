#!/usr/bin/env python3
"""Evaluation for rickmorty-multiverse-explorer-h1: 5 characters × 5 APIs"""
...
EXPECTED_COUNT = 5
KNOWN_DATA = {1: {"name": "Rick Sanchez", "status": "Alive", "species": "Human", "min_episodes": 40}, 2: {"name": "Morty Smith", "status": "Alive", "species": "Human", "min_episodes": 40}, 3: {"name": "Summer Smith", "status": "Alive", "species": "Human", "min_episodes": 30}, 4: {"name": "Beth Smith", "status": "Alive", "species": "Human", "min_episodes": 30}, 5: {"name": "Jerry Smith", "status": "Alive", "species": "Human", "min_episodes": 30}}
REQUIRED_FIELDS = ['id', 'name', 'significance_score', 'significance_tier', 'status', 'species', 'origin', 'episodes']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("rickmorty-multiverse-explorer-h1")
