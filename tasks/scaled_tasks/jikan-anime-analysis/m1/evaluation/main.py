#!/usr/bin/env python3
"""Evaluation for jikan-anime-analysis-m1: 4 anime × 4 APIs"""
...
REQUIRED_FIELDS = ['mal_id', 'title', 'quality_score', 'popularity_tier', 'score', 'characters', 'episodes_info', 'statistics']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("jikan-anime-analysis-m1")
