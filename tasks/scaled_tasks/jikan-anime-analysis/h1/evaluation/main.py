#!/usr/bin/env python3
"""Evaluation for jikan-anime-analysis-h1: 5 anime × 5 APIs"""
...
EXPECTED_COUNT = 5
KNOWN_DATA = {1: {"min_score": 8.0, "max_score": 9.5, "min_episodes": 20, "max_episodes": 30}, 5114: {"min_score": 9.0, "max_score": 10.0, "min_episodes": 60, "max_episodes": 70}, 1535: {"min_score": 8.0, "max_score": 9.5, "min_episodes": 35, "max_episodes": 40}, 16498: {"min_score": 8.0, "max_score": 9.5, "min_episodes": 20, "max_episodes": 30}, 9253: {"min_score": 8.5, "max_score": 9.5, "min_episodes": 20, "max_episodes": 30}}
REQUIRED_FIELDS = ['mal_id', 'title', 'quality_score', 'popularity_tier', 'score', 'characters', 'episodes_info', 'recommendations', 'statistics']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("jikan-anime-analysis-h1")
