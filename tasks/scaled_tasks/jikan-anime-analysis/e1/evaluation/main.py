#!/usr/bin/env python3
"""Evaluation for jikan-anime-analysis-e1: 3 anime × 3 APIs"""
...
REQUIRED_FIELDS = ['mal_id', 'title', 'quality_score', 'popularity_tier', 'score', 'characters', 'statistics']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("jikan-anime-analysis-e1")
