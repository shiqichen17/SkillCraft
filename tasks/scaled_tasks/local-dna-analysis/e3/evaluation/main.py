#!/usr/bin/env python3
"""Evaluation for local-dna-analysis-e3: 3 sequences × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['id', 'gc_content', 'nucleotide_counts', 'mrna', 'amino_acids']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("local-dna-analysis-e3")
