#!/usr/bin/env python3
"""Evaluation for local-dna-analysis-e2: 3 sequences × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['id', 'gc_content', 'is_valid', 'nucleotide_counts', 'mrna']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("local-dna-analysis-e2")
