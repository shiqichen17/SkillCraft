#!/usr/bin/env python3
"""Evaluation for local-dna-analysis-m2: 4 sequences × 4 APIs"""
...
EXPECTED_COUNT = 4
REQUIRED_FIELDS = ['id', 'gc_content', 'nucleotide_counts', 'max_nucleotide', 'mrna', 'amino_acids']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("local-dna-analysis-m2")
