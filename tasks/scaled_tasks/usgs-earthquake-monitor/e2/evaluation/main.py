#!/usr/bin/env python3
"""Evaluation for usgs-earthquake-monitor-e2: 3 regions × 3 APIs"""
...
EXPECTED_REGIONS = ['tokyo, japan', 'los angeles, usa', 'jakarta, indonesia']
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['name', 'coordinates', 'risk_level', 'earthquakes', 'statistics']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("usgs-earthquake-monitor-e2")
