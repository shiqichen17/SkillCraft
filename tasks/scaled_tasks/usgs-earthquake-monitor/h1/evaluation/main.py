#!/usr/bin/env python3
"""Evaluation for usgs-earthquake-monitor-h1: 5 regions × 5 APIs"""
...
EXPECTED_REGIONS = ['tokyo, japan', 'los angeles, usa', 'jakarta, indonesia', 'santiago, chile', 'istanbul, turkey']
EXPECTED_COUNT = 5
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("usgs-earthquake-monitor-h1")
