#!/usr/bin/env python3
"""Evaluation for usgs-earthquake-monitor-e3: 3 regions × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['name', 'coordinates', 'risk_level', 'statistics']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("usgs-earthquake-monitor-e3")
