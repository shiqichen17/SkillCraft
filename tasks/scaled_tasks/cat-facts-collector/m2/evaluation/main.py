#!/usr/bin/env python3
"""Evaluation for cat-facts-collector-m2: 4 breeds × 4 APIs"""
...
EXPECTED_BREEDS = ['persian', 'siamese', 'maine coon', 'ragdoll']
EXPECTED_COUNT = 4
REQUIRED_FIELDS = ['breed_name', 'country_relatives', 'coat_family', 'facts', 'encyclopedia_entry']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("cat-facts-collector-m2")
