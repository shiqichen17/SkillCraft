# Task: Cat Breed Encyclopedia (4 Breeds × 4 APIs) - M2

Create encyclopedia entries for **4 cat breeds** using 4 API endpoints per breed.

## Objective

For each of the following **4 cat breeds**, collect:
1. **Country Relatives**: breeds from same country
2. **Coat Family**: breeds with similar coat
3. **Facts Collection**: curated cat facts
4. **Encyclopedia**: full encyclopedia entry
...
```json
{
  ...
  "summary": {"total_breeds_analyzed": 4, "countries_covered": ["Iran/USA/UK"]},
