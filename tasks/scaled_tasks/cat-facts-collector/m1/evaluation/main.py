#!/usr/bin/env python3
"""Evaluation for cat-facts-collector-m1: 4 breeds × 4 APIs"""
...
EXPECTED_COUNT = 4
REQUIRED_FIELDS = ['breed_name', 'profile', 'country_relatives', 'coat_family', 'facts']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("cat-facts-collector-m1")
