#!/usr/bin/env python3
"""Evaluation for cat-facts-collector-h1: 5 breeds × 5 APIs"""
...
EXPECTED_BREEDS = ['persian', 'siamese', 'maine coon', 'ragdoll', 'bengal']
EXPECTED_COUNT = 5
REQUIRED_FIELDS = ['breed_name', 'profile', 'country_relatives', 'coat_family', 'facts', 'encyclopedia_entry']
