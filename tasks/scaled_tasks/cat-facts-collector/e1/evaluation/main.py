#!/usr/bin/env python3
"""Evaluation for cat-facts-collector-e1: 3 breeds × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['breed_name', 'profile', 'country_relatives', 'coat_family']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("cat-facts-collector-e1")
