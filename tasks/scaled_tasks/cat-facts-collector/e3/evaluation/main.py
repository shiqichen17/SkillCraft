#!/usr/bin/env python3
"""Evaluation for cat-facts-collector-e3: 3 breeds × 3 APIs"""
...
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['breed_name', 'country_relatives', 'coat_family', 'facts']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("cat-facts-collector-e3")
