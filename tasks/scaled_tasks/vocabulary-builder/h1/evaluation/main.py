#!/usr/bin/env python3
"""Evaluation for vocabulary-builder-h1: 5 words × 5 APIs"""
...
EXPECTED_WORDS = ['ephemeral', 'ubiquitous', 'pragmatic', 'eloquent', 'resilient']
EXPECTED_COUNT = 5
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("vocabulary-builder-h1")
