# Task: Vocabulary Builder (4 Words × 4 APIs) - M2
...
3. **Definitions**: all meanings
4. **Phonetics**: pronunciation info
...
3. `local-dictionary_definitions`
4. `local-dictionary_phonetics`
