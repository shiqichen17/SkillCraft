#!/usr/bin/env python3
"""Evaluation for vocabulary-builder-m1: 4 words × 4 APIs"""
...
EXPECTED_WORDS = ['ephemeral', 'ubiquitous', 'pragmatic', 'eloquent']
EXPECTED_COUNT = 4
REQUIRED_FIELDS = ['word', 'vocabulary_profile', 'meanings', 'synonyms']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("vocabulary-builder-m1")
