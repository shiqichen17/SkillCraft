#!/usr/bin/env python3
"""Evaluation for pokeapi-pokedex-e3: 3 Pokemon × 3 APIs"""
...
EXPECTED_IDS = [25, 6, 445]
EXPECTED_COUNT = 3
REQUIRED_FIELDS = ['id', 'name', 'species', 'evolution', 'abilities']
...
def evaluate(workspace, groundtruth_dir):
    score = EvalScore("pokeapi-pokedex-e3")
